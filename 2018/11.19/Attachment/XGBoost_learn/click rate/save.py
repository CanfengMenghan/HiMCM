...
train = pd.read_csv(r'D:\XGBoost_learn\mall_location\train.csv')
...
plt.stem(train['wifi_strong1'],train['wifi_id1'])
plt.show()
print(train.info())
...
gbm = xgb.XGBClassifier(silent=1, max_depth=10, n_estimators=1000,
                                            learning_rate=0.05)
